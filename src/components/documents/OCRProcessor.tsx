...
export const OCRProcessor: React.FC = () => {
  ...
  const processImage = async () => {
    ...
    try {
      // Simulate OCR processing (mock implementation)
      await new Promise(resolve => setTimeout(resolve, 3000));

      // Mock OCR result
      const mockText = `
        FRA CLAIM APPLICATION
        Name: Rajesh Kumar Gond
        Age: 45
      ...
      // Extract structured data from the mock text
      ...
      <div className="forest-card bg-forest-earth/10 border-forest-earth/30">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-forest-medium">
              This is a demonstration version of the OCR processor. In a production environment, 
              this would use Tesseract.js to perform actual OCR on uploaded images. 
              The current demo shows sample extracted data for demonstration purposes.
            </p>
          </div>
        </div>
      </div>
