...
import { TreePine, Shield, Users, MapPin, ArrowRight, Leaf, Mountain, Droplets } from 'lucide-react';
...
export const LandingPage: React.FC<LandingPageProps> = ({ onEmployeeLogin, onPublicLogin }) => {
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 max-w-4xl mx-auto mb-16">
              <button
                ...
                className="group flex-1 forest-button-primary text-lg py-6 px-8 bg-white/30 backdrop-blur-md border-2 border-white/50 hover:bg-white/40 hover:border-white/70 transform hover:scale-105 transition-all duration-500 rounded-3xl shadow-2xl"
              >
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <div className="text-left">
                    <div className="font-bold text-xl text-white">Employee Login</div>
                    <div className="text-sm text-white">Admin Dashboard Access</div>
                  </div>
